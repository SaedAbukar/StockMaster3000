...
public class InventoryCombox extends VerticalLayout {
  ...
  public InventoryCombox(SecurityService securityService, InventoryService inventoryService) {
    ...
    HorizontalLayout inventoryLayout = new HorizontalLayout(inventoryComboBox,
        addInventoryButton, deleteInventoryButton);
  ...
  private void showAddInventoryDialog() {
    ...
    Button saveButton = new Button(getTranslation("save"), e -> {
      ...
      try {
        // Pass the inventory name and the current user to the InventoryService
        Inventory newInventory = inventoryService.addInventory(inventoryName,
